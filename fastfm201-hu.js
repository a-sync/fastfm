...
// the flash player
var fastfm_player = 'http://cdn.last.fm/webclient/s12n/s/49/lfmPlayer.swf';
...
/* ---------- text ---------- */
var text = [];
text['collapse_expand'] = 'Panel nyitása / csukása.';
text['menu_close'] = 'bezár';
text['close_the_panel'] = 'Panel bezárása...';
text['settings_title'] = 'Beállítások!';
text['settings_alt'] = 'Beállítások!';
text['menu_playlist'] = 'számlista';
text['menu_radio'] = 'rádió';
text['playlist_and_samples'] = ' számlista és zene minták!';
text['and_similar_artists_radio'] = ' és hasonló előadók rádiója!';
text['settings'] = 'Beállítások';
text['default'] = 'Alap:';
text['playlist'] = 'Számlista';
text['radio'] = 'Rádió';
text['auto_start'] = 'Auto-indítás:';
text['auto_next'] = 'Auto-számváltás:';
text['position_from_top'] = 'Pozíció fentről:';
text['position_from_left_right'] = 'Pozíció balról / jobbról:';
text['apply'] = 'Alkalmaz';
text['menu_state_0'] = 'összecsuk';
text['menu_state_1'] = 'kinyit';
text['menu_state_2'] = 'összecsuk';
